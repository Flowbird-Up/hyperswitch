...
pub use self::{
    ...
    authorizedotnet::Authorizedotnet, archipel::Archipel, bamboraapac::Bamboraapac,
    bankofamerica::Bankofamerica, billwerk::Billwerk, bluesnap::Bluesnap, boku::Boku, braintree::Braintree,
